...
const data: CityPageData = {
  city: "Sheffield",
  headline: "Sheffield removals.<br />Fixed.<br />Fuss-free.",
sub: "Tell us about your Sheffield removal. Verified driver. price. ",
  stats: [
  ...
  steps: [
    ...
    { num: "02", title: "Driver confirmed", desc: "Verified Sheffield driver, confirmed and confirmed." },
  ...
  faq: [
    ...
    { q: "How fast is the response?", a: "Response to call within 15 minutes of posting. Driver confirmed and price locked before we hang up." },
    { q: "What if something gets damaged?", a: "Every move is fully insured. Response to handle damage claims directly. No complicated process." },
  ],
