...
const data: CityPageData = {
  ...
  steps: [
    ...
    { num: "02", title: "We find your driver", desc: "Verified Leeds driver, matched by our team within the minute." },
  ...
  faq: [
    ...
    { q: "How quickly do you respond?", a: "Our team calls within 60 seconds of you posting. Driver matched and price locked before we hang up." },
