...
function getTeachingMoment(problemType: string): string {
  const teachings: Record<string, string> = {
    ...
    hospital_supply_delivery: "Keeping patient care on schedule isn't only about medical skill. It's also about relying on a dependency that's often out of your control.",
    pharmacy_prescription_delivery: "Getting prescription deliveries on time isn't only about medication accuracy. It's also about relying on a dependency that's often out of your control.",
    construction_material_delivery: "Getting projects on schedule isn't only about planning. It's also about relying on a dependency that's often out of your control.",
    estate_agent_document_delivery: "Getting completions on time isn't only about negotiation. It's also about relying on a dependency that's often out of your control.",
    ...
    accounting_file_delivery: "Achieving tax compliance by deadline isn't only about calculations. It's also about relying on a dependency that's often out of your control.",
    ...
    veterinary_supply_delivery: "Keeping animal care on time isn't only about medical skill. It's also about relying on a dependency that's often out of your control.",
