...
export const BUSINESS_PAIN_PROMISE_MAP: Record<string, BusinessPainPromise> = {
  ...
  solicitor: {
    ...
    sharedReality: "Filing deadlines rarely become stressful because of the legal work itself. It's usually because one small dependency suddenly becomes the biggest risk.",
    rootCause: "It's usually because one small dependency suddenly becomes the biggest risk.",
    dependencyReveal: "More often than not, that's the delivery.",
