...
export const BUSINESS_PAIN_PROMISE_MAP: Record<string, BusinessPainPromise> = {
  ...
  court: {
    ...
    rootCause: "The real problem is when service of documents doesn't happen on time.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when justice matters.",
  ...
  insurance_company: {
    ...
    rootCause: "The real problem is when regulatory filings need to be submitted on time.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when compliance matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  insurance_broker: {
    ...
    rootCause: "The real problem is when policy documents don't arrive when promised.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when coverage matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
    subjectLines: ["One thing I've learnt", "Quick question", "When deadlines matter"],
  ...
  hospital: {
    ...
    rootCause: "The real problem is when supplies or equipment don't arrive exactly when scheduled.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when patient care matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  surgical_supplies: {
    ...
    rootCause: "The real problem is when critical supplies don't arrive on time.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when surgery matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  medical_devices: {
    ...
    rootCause: "The real problem is when devices don't arrive on the scheduled date.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when procedures matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  clinic: {
    ...
    rootCause: "The real problem is when supplies don't arrive when the patient does.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when urgent care matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  pharmacy: {
    ...
    rootCause: "The real problem is when prescriptions need to be filled and delivered on time.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when relief matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  legal: {
    ...
    rootCause: "The real problem is when document delivery gets in the way.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when cases matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  lawyer: {
    ...
    rootCause: "The real problem is when documents need to be filed and timing becomes critical.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when filings matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  attorney: {
    ...
    rootCause: "The real problem is when document delivery becomes unreliable.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when cases matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "ULTRA_MOTIVATED",
    tier: 1,
  ...
  film_production: {
    ...
    rootCause: "The real problem is when equipment doesn't arrive exactly when filming starts.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when sets matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
  ...
  tv_production: {
    ...
    rootCause: "The real problem is when equipment delivery gets delayed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when production schedules matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "HIGHLY_MOTIVATED",
    tier: 2,
  ...
  university_research: {
    ...
    rootCause: "The real problem is when time-sensitive samples don't arrive on schedule.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when research matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "HIGHLY_MOTIVATED",
    tier: 2,
  ...
  auction_house: {
    ...
    rootCause: "The real problem is when delivery windows get missed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when auctions matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "HIGHLY_MOTIVATED",
    tier: 2,
  ...
  jewelry_store: {
    ...
    rootCause: "The real problem is when delivery timing becomes unpredictable.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when timing is critical.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "HIGHLY_MOTIVATED",
    tier: 2,
  ...
  luxury_goods: {
    ...
    rootCause: "The real problem is when delivery expectations don't get met.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when premium service matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "HIGHLY_MOTIVATED",
    tier: 2,
  ...
  fashion_design: {
    ...
    rootCause: "The real problem is when sample deliveries get delayed past buyer meetings.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when collections matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "HIGHLY_MOTIVATED",
    tier: 2,
  ...
  estate_agent: {
    ...
    rootCause: "The real problem is when completion documents don't arrive on the agreed date.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when completions matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
  ...
  realtor: {
    ...
    rootCause: "The real problem is when closing documents get delayed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when closings matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  lettings: {
    ...
    rootCause: "The real problem is when paperwork delivery gets held up.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when lettings matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  property: {
    ...
    rootCause: "The real problem is when document delivery becomes unpredictable.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when transactions matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  accounting: {
    ...
    rootCause: "The real problem is when filings need to be submitted on the deadline.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when tax season matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  accountant: {
    ...
    rootCause: "The real problem is when documents don't arrive when they're due.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when tax deadlines matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
    subjectLines: ["One thing I've noticed", "Quick question", "When deadlines matter"],
  ...
  tax: {
    ...
    rootCause: "The real problem is when compliance documents don't arrive on time.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when tax compliance matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  bookkeeper: {
    ...
    rootCause: "The real problem is when reports don't arrive on schedule.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when month-end matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  construction: {
    ...
    rootCause: "The real problem is when materials don't arrive on schedule.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when projects matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  builder: {
    ...
    rootCause: "The real problem is when material delivery becomes unpredictable.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when builds matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  contractor: {
    ...
    rootCause: "The real problem is when supply delivery gets delayed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when schedules matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  plumber: {
    ...
    rootCause: "The real problem is when supply pickups get held up.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when appointments matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  electrician: {
    ...
    rootCause: "The real problem is when equipment delivery gets delayed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when installations matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  architecture: {
    ...
    rootCause: "The real problem is when drawing delivery gets held up.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when projects matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  architect: {
    ...
    rootCause: "The real problem is when delivery timelines slip outside your control.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when deadlines matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  engineering: {
    ...
    rootCause: "The real problem is when specification delivery gets delayed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when specs matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  ecommerce: {
    ...
    rootCause: "The real problem is when delivery speed becomes unpredictable.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when orders matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  retailer: {
    ...
    rootCause: "The real problem is when delivery windows get missed.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when inventory matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  retail: {
    ...
    rootCause: "The real problem is when inventory delivery gets disrupted.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when seasons matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  florist: {
    ...
    rootCause: "The real problem is when arrangements don't arrive exactly on time.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when events matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  event_planning: {
    ...
    rootCause: "The real problem is when supplier deliveries don't arrive on event day.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when events matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  hospitality: {
    ...
    rootCause: "The real problem is when supply delivery becomes unreliable.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when service matters.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
  ...
  restaurant: {
    ...
    rootCause: "The real problem is when critical supplies don't arrive before doors open.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when restaurants matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
    subjectLines: ["One thing I've learnt", "A thought", "When timing matters"],
  ...
  cafe: {
    ...
    rootCause: "The real problem is when stock delivery doesn't arrive before opening.",
    businessPhilosophy: "That's exactly why we built Saint & Story to take responsibility when cafes matter.",
    promiseStatement: "If a delivery ever fails with us, we'll cover the re-delivery at no cost to you.",
    consequenceLevel: "MOTIVATED",
    tier: 3,
