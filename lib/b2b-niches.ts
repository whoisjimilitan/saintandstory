...
export const B2B_NICHES: Record<string, B2BNiche> = {
  ...
  legal: {
    ...
    faqs: [
      ...
      { q: "Can you meet court deadlines?", a: "Driver confirmed in 15 minutes. We operate 7am to 10pm, seven days a week. For urgent court runs, call us directly: 0203 051 9243." },
