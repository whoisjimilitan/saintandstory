...
export default function OpportunityFeed({
  ...
  const toggleSection = (section: "available" | "confirmed" | "inProgress") => {
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="bg-white border border-[#E8E8E8] rounded-lg overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              <p className="font-semibold text-[#0D0D0D]">In Progress Jobs</p>
      ...
      <div className="bg-white border border-[#E8E8E8] rounded-lg overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            <p className="font-semibold text-[#0D0D0D]">Available Jobs</p>
            <p className="bg-[#0D0D0D] text-white text-[10px] font-semibold px-2 py-1 rounded-full">
              {awaitingJobs.length}
            </p>
          </div>
          <ChevronDown
            size={18}
            className={`text-[#888888] transition-transform ${
              expandedSections.available ? "rotate-180" : ""
            }`}
          />
        </button>
        {expandedSections.available && awaitingJobs.length > 0 && (
          <div className="border-t border-[#E8E8E8] px-4 py-3 space-y-2">
        ...
        {expandedSections.available && awaitingJobs.length === 0 && (
          <div className="border-t border-[#E8E8E8] px-4 py-3 text-center">
            <p className="text-[#888888] text-sm">No available jobs right now.</p>
          </div>
        )}
      </div>
    </div>
